...
/**
 * This is the model class for table "volunteer.vol_auth_item_child".
 *
 * The followings are the available columns in table 'volunteer.vol_auth_item_child':
...
class AuthItemChild extends CActiveRecord
{
	...
	{
		return 'volunteer.vol_auth_item_child';
	}
